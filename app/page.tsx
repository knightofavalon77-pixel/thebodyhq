    ...
    <div>
      ...
      <nav style={{ boxShadow: scrolled ? "0 4px 24px rgba(0,0,0,.4)" : "none" }}>
        ...
        <div className="nav-links">
          {TOOLS.map(t => (
            <a key={t.id} href={`/${t.id}`} className="nav-link">{t.icon} {t.name.split(" ")[0]}</a>
          ))}
        </div>
      ...
      <section className="tools-section" id="tools">
        ...
        <p className="section-sub">Five free science-backed calculators covering sleep, nutrition, fasting, pregnancy and mental wellness.</p>

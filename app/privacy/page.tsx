      ...
      <div className="main">
        ...
        {[
          ...
          { title: "5. Third Party Services", content: [
            ...
            <ul><li><strong>Google Analytics</strong> — Privacy policy at <a href="https://policies.google.com/privacy" className="contact-link" target="_blank" rel="noopener noreferrer">policies.google.com/privacy</a></li><li><strong>Google AdSense</strong> — Ad serving and monetization</li><li><strong>Netlify</strong> — Website hosting. Privacy policy at <a href="https://www.netlify.com/privacy" className="contact-link" target="_blank" rel="noopener noreferrer">netlify.com/privacy</a></li></ul>
          ]},
